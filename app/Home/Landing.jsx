...
function Landing() {
  return (
    <section
      ...
      className="w-screen bg-white p-10 text-black min-h-screen gap-5 flex justify-center items-center"
    >
      <div className="h-full  w-full bg-[#00000057] top-0 left-0 absolute"></div>

      <div className="flex z-50 flex-col bg-[#1515156b] justify-end items-center md:w-[40%]">
      ...
      <div className="flex flex-col md:w-[60%] gap-10 p-5 z-50 bg-[#07070781]">
